...
class DeletedItemRestoreSerializer(serializers.Serializer):
    ...
    def restore(self, deleted_item):
        ...
        try:
            ...
            # Intentar deserializar. El formato esperado es una lista de objetos serializados.
            try:
                deserialized_objects = list(serializers.deserialize('json', json_str))
            except Exception as e:
                # Si falla, quizás es un solo objeto y no una lista
            ...
            # 4. Forzar ID original para mantener integridad
            obj.pk = deleted_item.original_id
