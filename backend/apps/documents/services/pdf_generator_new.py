...
class ProfessionalPDFGenerator:
    ...
    def create_header(self, canvas, doc):
        ...
        if os.path.exists(logo_path):
            try:
                # Convertir SVG a imagen (simplificado)
        ...
        canvas.drawString(50, A4[1] - 80, self.company_info['name'])
        
        canvas.setFont('Helvetica', 10)
        canvas.drawString(50, A4[1] - 95, self.company_info['address'])
        canvas.drawString(50, A4[1] - 108, f"Tel: {self.company_info['phone']}")
    ...
    def generate_visit_report_pdf(self, report_data):
        ...
        story.append(Spacer(1, 10))
        story.append(Paragraph(f"<b>Motivo:</b> {report_data.get('visit_reason', 'N/A')}", self.styles['BodyText']))
        story.append(Spacer(1, 20))
        ...
        story.append(Spacer(1, 10))
        story.append(Paragraph(f"<b>Descripción de la Incidencia:</b><br/>{report_data.get('incident_description', 'N/A')}", self.styles['BodyText']))
        story.append(Spacer(1, 20))
        ...
        story.append(Paragraph(f"<b>{report_data.get('technician', 'N/A')}</b>", self.styles['BodyText']))
        story.append(Paragraph("Técnico", self.styles['BodyText']))
    ...
    def generate_quality_report_pdf(self, report_data):
        ...
        story.append(Spacer(1, 10))
        story.append(Paragraph(f"<b>Alcance:</b> {report_data.get('inspection_scope', 'N/A')}", self.styles['BodyText']))
        story.append(Paragraph(f"<b>Criterios:</b> {report_data.get('inspection_criteria', 'N/A')}", self.styles['BodyText']))
        story.append(Paragraph(f"<b>Método de Muestreo:</b> {report_data.get('sampling_method', 'N/A')}", self.styles['BodyText']))
        story.append(Paragraph(f"<b>Tamaño de Muestra:</b> {report_data.get('sample_size', 'N/A')}", self.styles['BodyText']))
        story.append(Spacer(1, 20))
        ...
        story.append(Spacer(1, 10))
        story.append(Paragraph(f"<b>Conclusiones:</b><br/>{report_data.get('conclusions', 'N/A')}", self.styles['BodyText']))
        story.append(Spacer(1, 10))
        story.append(Paragraph(f"<b>Recomendaciones:</b><br/>{report_data.get('recommendations', 'N/A')}", self.styles['BodyText']))
        story.append(Spacer(1, 20))
        ...
        story.append(Spacer(1, 30))
        story.append(Paragraph("_________________________", self.styles['BodyText']))
        story.append(Paragraph(f"<b>{report_data.get('follow_up_responsible', 'N/A')}</b>", self.styles['BodyText']))
        story.append(Paragraph("Responsable de Calidad", self.styles['BodyText']))
