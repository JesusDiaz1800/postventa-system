...
def create_incident_all_fields():
        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute("""
                INSERT INTO incidents (
                    ...
                    descripcion, acciones_inmediatas, categoria, subcategoria, prioridad, estado, 
                    lab_required, acciones_posteriores, nc_number, np_number, ai_analysis, 
                    ai_analysis_accuracy, fecha_cierre, closed_at, created_at, updated_at
                ) VALUES (
                    ...
                    'Calidad', 'Subcategoría Test', 'Alta', 'abierto', 0, 'Acciones posteriores',
                    'NC-001', 'NP-001', '{"analysis": "test"}', 0.95, NULL, NULL, datetime('now'), datetime('now')
                )
            """)
