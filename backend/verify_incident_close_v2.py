...
def test_incident_close_v2():
    print("=== TEST LÓGICA Incident.close() COLOMBIA (INC-2026-0025) ===")
    ...
    try:
        ...
        print(f"Estado final en DB local: {incident.status}")
