...
interface LoginIndustrialProps {
    onSubmit: (credentials: { username: string; password: string }) => void;
    isLoading?: boolean;
    error?: string;
}

export function LoginIndustrial({ onSubmit, isLoading = false, error }: LoginIndustrialProps) {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-[#020617] font-sans">
            ...
            {/* Modern Industrial IA Generated Background - OPTIMIZADO */}
            <div
                className="absolute inset-0 z-0 bg-cover bg-center transition-all duration-1000 scale-105 animate-slow-zoom"
                style={{
                    backgroundImage: `url('/assets/modern_industrial_bg.png')`,
                }}
            >
                {/* Cinematic Overlays - Blur REDUCIDO para performance */}
                <div className="absolute inset-0 bg-slate-950/85"></div>
                <div className="absolute inset-0 bg-gradient-to-tr from-[#020617] via-blue-900/20 to-[#020617]/90"></div>
                <div className="absolute inset-0 opacity-[0.08] bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:40px_40px]"></div>
                <div className="absolute inset-0 bg-radial-gradient from-transparent via-transparent to-slate-950/80"></div>
            </div>
            ...
            <div className="max-w-[480px] w-full px-6 relative z-10 animate-fade-in flex flex-col items-center">
                ...
                {/* Massive Industrial Login Card */}
                <div className="w-full relative group/card">
                    <div className="absolute -inset-[1px] bg-gradient-to-r from-blue-600/20 via-blue-400/10 to-indigo-600/20 rounded-[2.5rem] blur-[10px] opacity-30 group-hover/card:opacity-50 transition-opacity"></div>

                    <div className="relative bg-[#0f172a]/80 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-10 md:p-12 shadow-2xl">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <div className="flex items-center justify-center gap-2 mt-4">
                                <span className="h-[1px] w-3 bg-blue-500/20"></span>
                                <p className="text-blue-400 text-[9px] font-black uppercase tracking-[0.4em] leading-relaxed opacity-60">
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-5">
                                <div className="space-y-2">
                                    <label className="text-[9px] font-black text-slate-500 uppercase tracking-[0.2em] ml-1">Usuario</label>
                                    <div className="relative group/input">
                                        <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none text-slate-600 group-focus-within/input:text-blue-400 transition-colors duration-300">
                                            <Mail size={16} />
                                        </div>
                                        <input
                                            name="username"
                                            ...
                                            className="w-full bg-black/40 border border-white/5 focus:border-blue-500/50 rounded-2xl py-4 pl-12 pr-4 text-white text-sm outline-none transition-all placeholder:text-slate-800 font-bold tracking-tight shadow-inner"
                                ...
                                <div className="space-y-2">
                                    <label className="text-[9px] font-black text-slate-500 uppercase tracking-[0.2em] ml-1">Contraseña</label>
                                    <div className="relative group/input">
                                        <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none text-slate-600 group-focus-within/input:text-blue-400 transition-colors duration-300">
                                            <Lock size={16} />
                                        </div>
                                        <input
                                            ...
                                            onChange={handleChange}
                                            className="w-full bg-black/40 border border-white/5 focus:border-blue-500/50 rounded-2xl py-4 pl-12 pr-12 text-white text-sm outline-none transition-all placeholder:text-slate-800 font-bold tracking-tight shadow-inner"
                                            placeholder="••••••••"
                                            disabled={isLoading}
                                        />
                                        <button
                                            ...
                                            className="absolute inset-y-0 right-0 pr-5 flex items-center text-slate-700 hover:text-blue-400 transition-colors"
                                        >
                            ...
                            <div className="flex justify-end pr-1">
                                <button
                                    ...
                                    className="text-[8px] font-black text-slate-500 hover:text-white uppercase tracking-[0.2em] transition-all flex items-center gap-2 group/link"
                                >
                ...
                <div className="mt-8 pt-6 border-t border-white/5 flex flex-col items-center gap-1 opacity-20">
