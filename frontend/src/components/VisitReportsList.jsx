    ...
    mutationFn: async (incidentId) => {
      ...
      const response = await fetch('/api/documents/visit-reports/', {
        ...
        body: JSON.stringify({
          ...
          // order_number is auto-generated by backend with RV-YYYY-XXX format
              ...
              <div className="mb-6">
                <div className="flex space-x-4">
                  <button
                    ...
                    className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${createMode === 'form'
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${createMode === 'upload'
                      ? 'bg-blue-600 text-white'
                      : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                      }`}
                  >
