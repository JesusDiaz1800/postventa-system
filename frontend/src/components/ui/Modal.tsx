...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 bg-slate-900/60 backdrop-blur-md" onClick={closeOnOverlayClick ? onClose : undefined}>
      <div
        className={cn(
          'bg-white w-full overflow-hidden flex flex-col rounded-[2.5rem] relative shadow-2xl',
          sizes[size] || sizes.md,
          className
        )}
