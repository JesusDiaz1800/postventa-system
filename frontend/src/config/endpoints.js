...
const ENDPOINTS = {
  ...
  normal: {
    generatePolifusionLabReport: '/api/documents/generate-polifusion-lab-report/',
    ...
    generatePolifusionLabReportPDF: '/api/documents/generate-polifusion-lab-report-pdf/',
  ...
  test: {
    generatePolifusionLabReport: '/api/documents/test/generate-polifusion-lab-report/',
