...
const InternalQualityReportsPage = () => {
  ...
  // Query para obtener reportes de calidad internos
  const { data: reports, isLoading: reportsLoading } = useQuery({
    queryKey: ['quality-reports', { report_type: 'interno' }],
    queryFn: async () => {
      const response = await api.get('/documents/quality-reports/', {
        params: { report_type: 'interno' }
      });
  ...
  // Filtrar reportes por término de búsqueda - DEBE IR ANTES DE CUALQUIER RETURN
  ...
  // Verificar permisos - solo admin y supervisor pueden acceder
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-pink-50 to-rose-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">
            Solo administradores y supervisores pueden acceder a los informes internos de calidad.
          </p>
          <button
  ...
  const handleCreateReport = () => {
    ...
    // Redirigir al formulario específico de reporte de calidad interno
    navigate(`/quality-report-form/${selectedIncidentId}?report_type=interno`);
  };
  ...
  // Manejar eliminación de informe
  ...
  const handleEscalateToSupplier = async (incidentId) => {
    ...
    try {
      ...
      const response = await api.post(`/incidents/${incidentIdValue}/escalate/supplier/`, {
        reason: 'Escalado automáticamente desde informe interno de calidad'
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-pink-50 to-rose-50">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-500">
                  Gestión de informes internos de control de calidad (Solo Admin/Supervisor)
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 shadow-lg hover:shadow-xl transition-all duration-200"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6 relative z-10">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Buscar por número de informe, código de incidencia, cliente o proveedor..."
              value={searchTerm}
          ...
          <table className="min-w-full divide-y divide-gray-200">
                  ...
                  {filteredReports.map((report) => (
                    <tr key={report.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="text-xs text-red-600 font-medium">{report.categoria}</div>
                        {report.subcategoria && (
            ...
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Comienza creando un nuevo informe interno de calidad.
              </p>
              <div className="mt-6">
                <button
                  onClick={() => setShowCreateModal(true)}
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md">
            <div className="px-6 py-4 bg-gradient-to-r from-red-600 to-pink-600 rounded-t-2xl">
              <div className="flex items-center justify-between">
            ...
            <div className="p-6">
              ...
              <div className="flex justify-end pt-4 border-t border-gray-200">
                ...
                <button
                  ...
                  className="px-6 py-2 text-sm font-semibold text-white bg-red-600 hover:bg-red-700 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Crear Informe
                </button>
              </div>
      ...
      {showUploadModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md">
            <div className="px-6 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-t-2xl">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-white flex items-center">
                  <DocumentArrowUpIcon className="h-5 w-5 mr-2" />
                  Adjuntar Documento Interno
                </h3>
                <button
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                <button
                  ...
                  className="w-full flex items-center justify-center px-6 py-4 border-2 border-dashed border-gray-300 text-sm font-semibold rounded-xl text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
