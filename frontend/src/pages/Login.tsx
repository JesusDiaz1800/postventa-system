...
const COUNTRIES = [
    { code: 'CL', name: 'Chile', flag: '🇨🇱', flagPath: '/assets/flags/cl.png', color: 'from-red-500 to-blue-500', db: 'SERTEC_CL' },
    { code: 'PE', name: 'Perú', flag: '🇵🇪', flagPath: '/assets/flags/pe.png', color: 'from-red-500 to-red-600', db: 'SERTEC_PE' },
    { code: 'CO', name: 'Colombia', flag: '🇨🇴', flagPath: '/assets/flags/co.png', color: 'from-yellow-400 to-red-500', db: 'SERTEC_CO' }
];
            ...
            <div className="max-w-[480px] w-full px-6 relative z-10 animate-fade-in flex flex-col items-center">
                ...
                <div className="mt-8 pt-6 border-t border-white/5 flex flex-col items-center gap-1 opacity-40">
                    ...
                    <span className="text-[9px] font-black text-white/40 uppercase tracking-[0.4em] text-center ml-[0.4em] whitespace-nowrap">
                        Sertec System v1.0 • Polifusión S.A.
                    </span>
                </div>
            </div>
