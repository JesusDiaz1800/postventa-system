...
export const documentsAPI = {
  ...
  getByIncidents: (params?: PaginationParams) => api.get('/documents/by-incidents/', { params }),
  ...
  generateForIncident: (incidentId: string | number, data: any) => api.post(`/documents/generate/${incidentId}/`, data),
  ...
  createVisitReport: (data: any) => api.post('/documents/visit-reports/', data),
  createSupplierReport: (data: any) => api.post('/documents/supplier-reports/', data),
};
